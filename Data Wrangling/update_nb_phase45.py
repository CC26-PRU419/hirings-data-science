...
nb.cells.extend([
    nbf.v4.new_markdown_cell('# Phase 4: Save Data Dictionary'),
    nbf.v4.new_code_cell('''data_dict_md = """# Data Dictionary — LinkedIn Jobs Cleaned Dataset
...
print("Data Dictionary saved to output/data_dictionary.md!")'''),
    nbf.v4.new_markdown_cell('# Phase 5: Final Validation & Handoff Checklist'),
